...
class LastEditedPlugin extends Gdn_Plugin {
   ...
   protected function DrawEdited($Sender) {
      ...
      $Format = T('PostEdited.Plain', 'Post modificato da {EditUser} {EditWord} {EditDate}');
      if ($UserCanEdit)
         $Format = T('PostEdited.Log', 'Post modificato da {EditUser} {EditWord} {EditDate} (<a href="{EditLogUrl}">log</a>)');
